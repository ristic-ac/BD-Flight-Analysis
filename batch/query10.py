...
# Which flight was the most expensive, and could the ticket be refunded?
QUERY10 = df.select("legId", "totalFare", "isRefundable") \
            .filter(df.isRefundable == True) \
            .sort(col("totalFare").desc()) \
            .limit(1) \
