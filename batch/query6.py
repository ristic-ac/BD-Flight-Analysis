...
# Determine most common string inside segmentsArrivalAirportCode, excluding last element in array, and excluding occurences where only one element is present in array
