...
# Calculate the average price of flight for each airline, windowed every 30 seconds and sliding every 30 seconds (Rolling window)
df_flights = df_flights \
  .withWatermark("timestamp_received", "1 seconds") \
  .groupBy(window("timestamp_received", "30 seconds", "30 seconds"), "airline") \
